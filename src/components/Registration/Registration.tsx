        ...
        >
          ...
          >
            ...
            <div className={styles.input__container}>
              <input className={`${styles.input__box}`}></input>
            </div>
          </div>
          <div
            className={`${styles.input} ${
          ...
          <div
            className={`${styles.input} ${
              currentStep === 2 ? styles.input__active : styles.input__inactive
            }`}
          >
            <label className={styles.input__label}>Дата рождения</label>
            <div>
              <DatePicker
                style={{ border: "0", width: "330px", height: "48px" }}
              />
            </div>
          </div>
          <div
            style={{ height: "165px", border: "0", background: "transparent" }}
            className={`${styles.input} ${
              currentStep === 2 ? styles.input__active : styles.input__inactive
            }`}
          >
            ...
            >
              ...
              >
                ...
                <img
                  height={"100%"}
                  src={sberCat}
                  style={{ left: "0", position: "absolute", bottom: "-16px" }}
                />
              </div>
              <hr
                style={{
          ...
          <div
            className={`${styles.input} ${
              currentStep === 3 ? styles.input__active : styles.input__inactive
            }`}
          >
            <label className={styles.input__label}>Ник на платформе</label>
            <div>
              <input type="password" className={`${styles.input__box}`}></input>
            </div>
          </div>
          <div
            className={`${styles.input} ${
          ...
          <div
            className={`${styles.input} ${
              currentStep === 4 ? styles.input__active : styles.input__inactive
            }`}
          >
          ...
          >
            <label className={styles.input__label}>Подтверждение пароля</label>
            <div>
              <input type="password" className={`${styles.input__box}`}></input>
            </div>
          </div>
