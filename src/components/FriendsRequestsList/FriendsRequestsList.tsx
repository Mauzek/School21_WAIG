...
const friends: User[] = [
  {
    ...
    birthday: "1999-04-15",
    description:
      "Любитель технологий и игр sdf sdf sdf sdf dfsd fsdfs dsd fsdfsds dfs dfs dfs dfs dfs ds dfsd fsdfs dfsd sdfsdfs dfs dfs dfsd fsd sd sdf sdf sdf sdfs dfsd fds fsdfs fsd fsd dfsd fsdfs d fsdfs sdf s",
...
export const FriendsRequestsList: FC = () => {
      ...
      {friends.map((friend) => {
        ...
        return (
          <RequestCard
            ...
            avatar={avatarId}
            cancleRequest={handleCancelRequest}
