...
const {updateUserStore,setToken} = useStore();
  ...
  return (
    <main className={styles.auth__centre}>
      <div className={isAuther ? styles.auth : styles.reg} style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
        <div className={styles.auth__asd1}>
          {isAuther ?
            <div className={styles.auth__container} >
              <h2 className={styles.login__title}>Добро пожаловать в WAIG</h2>
              <p className={styles.login__description}>Пожалуйста, введите свой логин и пароль, которые вы указали при регистрации для входа в систему </p>
              <form className={styles.login__form} onSubmit={handleSubmit}>
                <div className={styles.input}>
                  ...
                  <div className={styles.input__container} >
                    <input className={`${styles.input__box}`} name="username" value={authData.username} onChange={handleInput}>
                    </input>
                  </div>
                </div>
                ...
                <div className={styles.login__container}>
                  <button className={styles.login__Button} type="submit"> <div>Войти</div>
