      ...
      <div className={styles.auth}>
        {isAuther ? (
          <div className={styles.auth__container}>
            ...
            >
              {" "}
              Пожалуйста, введите свой логин и пароль, которые вы получили ранее
              для входа в систему{" "}
            </p>
            <form style={{ marginTop: "40px" }}>
              ...
              >
                Если вы хотите учиться в школе следующего поколения, перейдите
                по{" "}
